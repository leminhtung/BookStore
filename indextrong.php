    ...
    <div class="main-content-wrapper d-flex clearfix">
       ...
       <?php if(isset($_SESSION['Phone']) && isset($_SESSION['password'])) {?>
            ...
            <div style="width:100%;background-color: #3f3567; height: 80px;display: inline-table;">
               <a href="index.php"><img src="img/core-img/logo6.jpg" alt="" style="height:80px;float: left; "></a>
                ...
                <?php if( $_SESSION['roleid'] === "1" ) {?>
                 <a style="font-size: 14px; background-color: #3f3567; color: white;"><span style = "color: #dc3545">Xin Chào: &nbsp;&nbsp;</span><a href="dashboard.php" style="color: white"><?php echo $_SESSION['Phone']; ?></a> 
                  <?php  } else { ?>
                    ...
                    <li>
                        <li class="dropdown-submenu">
                          ...
                          <?php
                            ...
                            $connectionInfo = array( "Database"=>"BookStore", "UID"=>"sa", "PWD"=>"test123!", "CharacterSet" => "UTF-8");
        ...
        <div class="amado_product_area section-padding-100">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    if(isset($_GET['id'])) {
                        $id = $_GET["id"];
                        $result = sqlsrv_query($conn, "select * from Books where CategoryID=$id");
                    } else {
                        $result = sqlsrv_query($conn, "select * from Books where Books.Enabled=1");
                    }  
