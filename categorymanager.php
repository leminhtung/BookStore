...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">            
            <div class="container-fluid">
                <div style="text-align: center;margin-top: -21px;margin-bottom:8px;"><a class="btn btn-primary" href="insertcategory.php" role="button">Thêm</a></div>
                <div class="row">
                                ...
                                <tbody>     
                                    <?php foreach ($params as $row) : ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center"><a class="btn btn-primary" href="updatecategory.php?cateid=<?php echo $row['CategoryID'] ?>"<" role="button">Cập Nhật</a></td>
