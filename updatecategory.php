<?php
    ...
    $params = $postcontroller->GetCategoryDetail($_GET['cateid']);
    $data["Category"] = $params['Name'];        
    $data["chkEnabled"] =  $params["Enabled"];
    ...
    if ($data['Category'] == '') 
    {
        $error['Category'] = "Category is empty!!!";
    }

    if (empty($error)) 
    { 
    	echo 'chkEnabled'.$data["chkEnabled"];
    	$_SESSION["cateid"];        		               
        $isSuccess = $postcontroller -> updateCateToDb($_SESSION["cateid"],$data["Category"],$data["chkEnabled"]);
                        ...
                        <form  method="Post" >
                            ...
                            <div class="form-group">
                                <div style="display: flex; " >
                                    ...
                                    <input type="checkbox" name="chkEnabled"  id="chkEnabled"  style="width: 20px;height: 35px; margin-left: 10px" value="<?php echo $data['chkEnabled'] ?>" />
                                    <!-- <input type="hidden" name="chkEnabled"> -->
                                </div>
                            </div>                                     
                            <div class="form-group">
                                <div class="row">
