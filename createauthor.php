  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Tạo Tác giả</a>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-7">
                <div class="card">
                    ...
                    <div class="content">
                        ...
                        if (isset($_POST['submit'])) 
                        {
                            ...
                            if(!$error) {
                                $result = sqlsrv_query($conn, "INSERT INTO Authors(Name, Description, Enabled) VALUES ('$Name', '$discrip', 1)");
                                if($result){
                                    echo "create success";
                ...
                <div class="text-center">
                    <button type="submit" name="submit" class="btn btn-info btn-fill btn-wd">Tạo Tác giả Mới</button>
                </div>
